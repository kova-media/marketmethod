...
export default function Dashboard(){
 ...
 useEffect(()=>{
  Promise.all([fetch('/api/crm/auth/me'),fetch('/api/crm/contacts'),fetch('/api/crm/tasks'),fetch('/api/crm/appointments'),fetch('/api/crm/pipeline')]).then(async ([a,b,c,d,e])=>{
   ...
   setUser(ad.user);setContacts(bd.contacts||[]);setTasks(cd.tasks||[]);setAppointments(dd.appointments||[]);setStages(ed.stages||[])
  })
 },[])
