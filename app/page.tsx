...
function LeadModal({ onClose }: { onClose: () => void }) {
  ...
  async function submitLead(event: FormEvent<HTMLFormElement>) {
    ...
    const payload = {
      ...
      improvements: data.getAll('improvements').join(', '),
  ...
  return (
    <div className="dashboard-preview">
      ...
      <div className="dashboard-activity">
        ...
        <div><strong>Quote request</strong><small>Follow up · 12 min ago</small></div>
        <div><strong>Past customer</strong><small>Re-engage · 3 days ago</small></div>
        <div><strong>Service customer</strong><small>Reminder due · Tomorrow</small></div>
      </div>
    </div>
  )
}
    ...
    <main>
      ...
      <section className="system-section" id="system">
        <div className="wrap">
          <div className="system-heading">
            <div>
              <p className="eyebrow">ONE CUSTOMER JOURNEY</p>
              <h2>Every handoff is a chance to lose the customer.</h2>
            </div>
            <p>Market Method closes the gaps between finding you, contacting you, buying from you, and coming back.</p>
          </div>
          <div className="journey">
            <article><span>1</span><strong>Find</strong><p>Your website gives the right customer a reason to contact you.</p></article>
            <article><span>2</span><strong>Reach out</strong><p>The inquiry becomes a customer record, not another message to remember.</p></article>
            <article className="journey-gap"><span>3</span><strong>Follow up</strong><p>When they do not respond, the conversation keeps moving.</p><em>GAP CLOSED</em></article>
            <article><span>4</span><strong>Buy</strong><p>The customer has a clear path to book, buy, or take the next step.</p></article>
            <article className="journey-gap"><span>5</span><strong>Come back</strong><p>Reminders, check-ins, and reactivation create another reason to return.</p><em>GAP CLOSED</em></article>
          </div>
        </div>
      </section>
      ...
      <section className="owner-section section-stone" id="owner">
        <div className="wrap owner-grid">
          <div className="owner-copy">
            ...
            <h2>You should not have to remember who needs a call.</h2>
            <p>Market Method puts the customer work that normally lives in your head, inbox, spreadsheet, and calendar into one place.</p>
            <div className="automation-list">
              <div><strong>Lead comes in</strong><span>Customer record created</span></div>
              <div><strong>Lead goes quiet</strong><span>Follow-up is triggered</span></div>
              <div><strong>Service is complete</strong><span>Check-in is scheduled</span></div>
              <div><strong>Customer goes quiet</strong><span>Reactivation can begin</span></div>
            </div>
          </div>
          <DashboardPreview />
        </div>
      ...
      <section className="proof-section wrap">
        <div className="proof-intro">
          ...
          <h2>Less chasing. More customers moving through the business.</h2>
        </div>
        <div className="proof-grid">
          <div><strong>Website</strong><p>A better front door for the business.</p></div>
          <div><strong>Customer system</strong><p>One place for leads, customers, conversations, and next steps.</p></div>
          <div><strong>Automation</strong><p>Routine follow-up and retention without another task on your list.</p></div>
        </div>
      </section>
