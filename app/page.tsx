...
export default function Home() {
  ...
  return <main>
    <nav className="nav wrap" aria-label="Main navigation"><a href="#top" className="brand" aria-label="Market Method home"><img src="/logo.png" alt="Market Method"/></a><div className="nav-links"><a href="#system">The system</a><a href="#owner">The owner view</a><a href="#questions">Questions</a><a href="/crm">Client Login</a></div><button className="button nav-cta" onClick={()=>setModal(true)}>Get Started</button></nav>
    <section className="hero wrap" id="top"><div className="hero-copy"><p className="eyebrow">FOR LOCAL BUSINESSES</p><h1>GET MORE CUSTOMERS.<br/>KEEP MORE CUSTOMERS.</h1><div className="hero-bottom"><p className="hero-sub">YOUR NEXT CUSTOMER IS ONLY THE BEGINNING.</p><p className="hero-description">Market Method connects the website, lead follow-up, customer records, and retention that keep a customer relationship moving.</p><div className="hero-actions"><button className="button" onClick={()=>setModal(true)}>Get Started</button></div></div></div></section>
    ...
    <footer className="footer wrap"><a href="#top" className="brand footer-brand" aria-label="Market Method home"><img src="/logo.png" alt="Market Method"/></a><div className="footer-meta"><p>© 2026 Market Method, a division of Kova Media Group</p><a href="/crm">Client Login</a></div></footer>
