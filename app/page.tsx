...
export default function Home() {
  ...
  return <main>
    ...
    <section className="hero wrap" id="top"><div className="hero-copy"><p className="eyebrow">FOR LOCAL BUSINESSES</p><h1>Get more customers.<br/>Keep more customers.</h1><div className="hero-bottom"><p className="hero-sub">Your next customer is only the beginning.</p><div className="hero-actions"><button className="button" onClick={()=>setModal(true)}>Get Started</button></div></div></div></section>
