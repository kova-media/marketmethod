  ...
  return <div className="modal-backdrop" onClick={onClose}><div className="modal" onClick={e=>e.stopPropagation()}>
    ...
    {status==='success' ? <div className="form-success"><p className="form-kicker">REQUEST RECEIVED</p><h2>We got it.</h2><p>Your information has been sent. We will review what you shared and be in touch.</p><button className="button" onClick={onClose}>Done</button></div> : <>
      ...
      <form onSubmit={submitLead}>
        ...
        <div className="form-grid"><input name="phone" type="tel" placeholder="Phone number" aria-label="Phone number" autoComplete="tel"/><input required name="businessName" placeholder="Business name *" aria-label="Business name" autoComplete="organization"/></div>
...
export default function Home() {
  ...
  return <main>
    ...
    <footer className="footer wrap"><a href="#top" className="brand footer-brand" aria-label="Market Method home"><img src="/logo.png" alt="Market Method"/></a><p><a href="mailto:contact@marketmethod.co">contact@marketmethod.co</a></p><p>© 2026 Market Method, a division of Kova Media Group</p></footer>
